...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            personImages.add(new Image(new FileInputStream("src/sample/images/person.png")));
            personImages.add(new Image(new FileInputStream("src/sample/images/person.png")));
            personImages.add(new Image(new FileInputStream("src/sample/images/person.png")));
            personImages.add(new Image(new FileInputStream("src/sample/images/person.png")));
            elevatorImage = new Image(new FileInputStream("src/sample/images/lightRect.png"));
            roofImage = new Image(new FileInputStream("src/sample/images/base.jpg"));
        ...
        strategy_cb.getItems().add("First");
        strategy_cb.getItems().add("Second");

        strategy_cb.setValue("First");
    ...
    private void renderFloors(int count) {
        ...
        for (int i = 1; i <= count; i++) {
            ...
            curFloor.setFill(new Color(0.9, 0.9, 0.9, 0.9));
    ...
    private void movePersonOutOfElevator(int elevator) {
        ...
        moveOfElevatorAnimation.setToX(35);
